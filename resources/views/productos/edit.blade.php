...
@section('content')
    ...
    <div class="grid grid-cols-1">
        <div class="space-y-6 w-2xl mx-auto">
            <x-common.component-card title="Formulario Editar Producto">
                <form action="{{route('productos.update', $producto)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            <input type="text" name="nombre" id="nombre" value="{{old('nombre', $producto->nombre)}}" placeholder="Nombre de producto"
                                @class([
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            <input type="text" name="descripcion" id="descripcion" value="{{old('descripcion', $producto->descripcion)}}" placeholder="Descripcion de producto"
                                @class([
                                    'dark:bg-dark-900 shadow-theme-xs w-full rounded-lg border bg-transparent px-4 py-2.5 pr-10 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30', 
                    ...
                    <div class="flex gap-4 mb-5">
                        <div class="w-1/2">
                            ...
                            <div class="relative">
                                <input type="number" name="precio" id="precio" value="{{old('precio', $producto->precio)}}" placeholder="Precio de producto"
                                    @class([
                                        'dark:bg-dark-900 shadow-theme-xs w-full rounded-lg border bg-transparent px-4 py-2.5 pr-10 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30', 
                        ...
                        <div class="w-1/2">
                            ...
                            <div class="relative">
                                <input type="number" name="costo" id="costo" value="{{old('costo', $producto->costo)}}" placeholder="Costo de producto"
                                    @class([
                                        'dark:bg-dark-900 shadow-theme-xs w-full rounded-lg border bg-transparent px-4 py-2.5 pr-10 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30', 
                    ...
                    <div class="flex gap-4 mb-5">
                        <div class="w-1/2">
                            ...
                            <div class="relative">
                                <input type="number" name="stock_minimo" id="stock_minimo" value="{{old('stock_minimo', $producto->stock_minimo)}}" placeholder="Stock minimo de producto"
                                    @class([
                                        'dark:bg-dark-900 shadow-theme-xs w-full rounded-lg border bg-transparent px-4 py-2.5 pr-10 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30', 
                        ...
                        <div class="w-1/2">
                            ...
                            <div class="relative">
                                <input type="text" name="sku" id="sku" value="{{old('sku', $producto->sku)}}" placeholder="Código de producto"
                                    @class([
                                        'dark:bg-dark-900 shadow-theme-xs w-full rounded-lg border bg-transparent px-4 py-2.5 pr-10 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30', 
                    ...
                    <div class="mb-5">
                        ...
                        <select name="categoria_id" id="categoria_id" class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
                            @foreach ($categorias as $categoria)
                                <option {{$producto->categoria_id == $categoria->id ? 'selected' : ''}} value="{{$categoria->id}}" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                    {{$categoria->nombre}}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-5">
                        ...
                        <figure class="w-[200px] mx-auto">
                            <img src="{{asset('storage/'.$producto->img_path)}}" alt="" class="w-full">
                        </figure>
                    </div>

                    <div>
                        <x-ui.button size="sm" variant="outline" type="submit">Actualizar</x-ui.button>
                    </div>
                </form>            
