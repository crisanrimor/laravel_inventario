...
@section('content')
    ...
    <x-common.component-card title="Nueva Categoria">
        <div class="flex items-center gap-5">
            <a href="{{route('categorias.create')}}"><x-ui.button size="sm" variant="primary" :startIcon="$BoxIcon">Crear Categoria</x-ui.button></a>
        </div>
    </x-common.component-card>

    <div class="mt-5">
        <x-common.component-card title="Lista de Categorias">
                ...
                <table class="w-full mb-5">
                    <thead class="px-6 py-3.5 border-t border-gray-100 border-y bg-gray-50 dark:border-white/[0.05] dark:bg-gray-900">
                        <tr>
                            ...
                            <th class="px-6 py-3 font-medium text-gray-500 sm:px-6 text-theme-xs dark:text-gray-400 text-start">Descripción</th>
                        ...
                        @foreach ($categorias as $categoria)
                            <tr class="border-b border-gray-100 dark:border-white/[0.05]">
                                <td class="px-4 sm:px-6 py-3.5">
                                    <p class="text-gray-700 text-theme-sm dark:text-gray-400">{{$categoria->nombre}}</p>
                                </td>
                                <td class="px-4 sm:px-6 py-3.5">
                                    <p class="text-gray-700 text-theme-sm dark:text-gray-400">{{$categoria->descripcion ?? 'Sin descripción'}}</p>
                                </td>
                                <td class="px-4 sm:px-6 py-3.5">
...
@push('scripts')
    <script>
        const openModal = (id) => {
            ...
            formModal.action = `{{url('/categorias')}}/${id}`
        };
