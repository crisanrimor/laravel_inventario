...
@section('content')
    ...
    <div class="grid grid-cols-1">
        <div class="space-y-6 w-2xl mx-auto">
            <x-common.component-card title="Formulario Editar Categoria">
                <form action="{{route('categorias.update', $categoria)}}" method="POST">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="nombre" id="nombre" value="{{old('nombre', $categoria->nombre)}}" placeholder="Nombre de categoría"
                                @class([
                    ...
                    <div class="mt-5 mb-5">
                        ...
                        <input value="{{old('descripcion', $categoria->descripcion)}}" id="descripcion" type="text" placeholder="Descripción de categoría"
