...
@section('content')
    <x-common.page-breadcrumb pageTitle="Crear Categoria" />

    <div class="grid grid-cols-1">
        <div class="space-y-6 w-2xl mx-auto">
            <x-common.component-card title="Formulario Crear Categoria">
                <form action="{{route('categorias.store')}}" method="POST">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="nombre" id="nombre" value="{{old('nombre')}}" placeholder="Nombre de categoría"
                                @class([
                    ...
                    <div class="mt-5 mb-5">
                        ...
                        <input value="{{old('descripcion')}}" id="descripcion" type="text" placeholder="Descripción de categoría"
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" name="descripcion"/>
                    </div>
